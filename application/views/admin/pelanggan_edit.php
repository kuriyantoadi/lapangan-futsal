    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 align="center" class="card-title">Edit Data Pelanggan</h5>
              ...
              <div class="row mb-3">
                <label for="inputText" class="col-sm-2 col-form-label">nama_club</label>
                <div class="col-sm-10">
                  <input type="text" name="nama_club" value="<?= $row->nama_club ?>" class="form-control">
                </div>
              </div>
